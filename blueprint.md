...
1. **Implement Theme Toggle:**
    - [x] Add toggle button to `index.html`.
    - [x] Define CSS variables for Light/Dark modes in `style.css`.
    - [x] Add JavaScript logic for theme switching and persistence in `main.js`.
2. **Deployment:**
